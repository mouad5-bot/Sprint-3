...
<div class="main d-flex">
			...
			<div class="card">
				<div class="card-body">
					<h1 class="card-title text-info text-center mb-3">Sign ip</h1>
					<form action="index.php" method="POST">
						<div class="">
							<div class="mb-3">
								<label for="name" class="form-label">Full name</label>
								<input type="text" class="form-control" id="full-name"  name="full_name" placeholder="veuillez entrez votre email">
							</div>
							<div class="mb-3">
							...
							<div class="d-grid gap-2">
								<button class="btn btn-info text-white" type="submit" name="signup">Register</button>
								<span>Already have an account ? <a href="Signup.php"> Login </a></span>
							</div> 
						</div>	
					</form>
				</div>
